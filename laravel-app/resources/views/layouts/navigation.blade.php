        ...
        <div class="flex h-14 justify-between">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2 text-slate-900 dark:text-slate-100">
                        <span class="inline-flex h-9 w-9 items-center justify-center rounded-md bg-slate-900 text-white dark:bg-slate-100 dark:text-slate-900">
                            <x-application-logo class="h-5 w-5" />
                        </span>
                        <span class="hidden text-sm font-semibold sm:block">VMHub</span>
                    </a>
                </div>
