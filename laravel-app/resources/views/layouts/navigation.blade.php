        ...
        <div class="flex h-14 justify-between">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2 text-slate-100">
                        <span class="inline-flex h-9 w-9 items-center justify-center rounded-md bg-white text-slate-950">
            ...
            <div class="hidden gap-2 sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center rounded-md border border-transparent bg-slate-900 px-3 py-2 text-sm font-medium leading-4 text-slate-400 transition ease-in-out duration-150 hover:text-slate-100 focus:outline-none">
                ...
                @if (Auth::user()->is_admin)
                    <x-icon-link
                        ...
                        :label="__('Settings')"
                        @class([
                            'bg-slate-900 text-white' => request()->routeIs('settings.*'),
                        ])
                    >
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center rounded-md p-2 text-slate-400 transition hover:bg-slate-900 hover:text-slate-100 focus:outline-none">
